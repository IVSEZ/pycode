...
header2 = ["kod1", "firm1", "parcel1", "kod2", "firm2", "parcel2", "score_tser"]
header3 = ["kod1", "firm1", "parcel1", "kod2", "firm2", "parcel2", "score_r", "score_pr", "score_tsor", "score_tser", "score_ptsor",
...
file3 = 'C:\_out\cust_parcel_score_' + timestr + '.csv'
...
with open(file3, 'w', newline='', encoding="utf-8") as outfile3:
    ...
    for line in f:
        ...
        # if parcel1 != '986-1145-1-0-94' and parcel1 != '005-0521-7-1-23' and parcel1 != '986-0567-1-1-10':
            # score_r = fuzz.ratio(parcel1, parcel2)
            # score_pr = fuzz.partial_ratio(parcel1, parcel2)
            # score_tsor = fuzz.token_sort_ratio(parcel1, parcel2)
        score_tser = fuzz.token_set_ratio(parcel1, parcel2)
            # score_ptsor = fuzz.partial_token_sort_ratio(parcel1, parcel2)
            # score_ptser = fuzz.partial_token_set_ratio(parcel1, parcel2)
            # score_qr = fuzz.QRatio(parcel1, parcel2)
            # score_uqr = fuzz.UQRatio(parcel1, parcel2)
            # score_wr = fuzz.WRatio(parcel1, parcel2)
            # score_uwr = fuzz.UWRatio(parcel1, parcel2)
        ...
        if score_tser > 99:
            # temp3 = (
            #     kod1, firm1, parcel1, kod2, firm2, parcel2, score_r, score_pr, score_tsor, score_tser, score_ptsor,
            #     score_ptser, score_qr,
            #     score_uqr, score_wr, score_uwr)

            temp3 = (kod1, firm1, parcel1, kod2, firm2, parcel2, score_tser)
